...
var _hero = require("./modules/sliders/hero");
var _tours = require("./modules/sliders/tours");
var _trainers = require("./modules/sliders/trainers");
var _reviews = require("./modules/sliders/reviews");
var _advantages = require("./modules/sliders/advantages");
var _gallery = require("./modules/sliders/gallery");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _hero.initSwiperHero)();
  (0, _tours.initSwiperTours)();
  (0, _trainers.initSwiperTrainers)();
  (0, _reviews.initSwiperReviews)();
  (0, _advantages.initSwiperAdvantages)();
  (0, _gallery.initSwiperGallery)();
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/sliders/advantages":11,"./modules/sliders/gallery":12,"./modules/sliders/hero":13,"./modules/sliders/reviews":14,"./modules/sliders/tours":15,"./modules/sliders/trainers":16,"./utils/ios-vh-fix":19}],2:[function(require,module,exports){
"use strict";
...
exports.initSwiperAdvantages = void 0;
var desktop = window.matchMedia('(min-width: 1440px)'); // сами подберите нужный брейкпоинт
var initSwiperAdvantages = exports.initSwiperAdvantages = null;
if (desktop.matches) {
  exports.initSwiperAdvantages = initSwiperAdvantages = new Swiper('.advantages__slider', {
    // Navigation arrows
    navigation: {
...
exports.initSwiperGallery = void 0;
var initSwiperGallery = exports.initSwiperGallery = new Swiper('.gallery__slider', {
  // Navigation arrows
  navigation: {
...
var initSwiperHero = exports.initSwiperHero = new Swiper('.hero__slider', {
...
var initSwiperReviews = exports.initSwiperReviews = new Swiper('.reviews__slider', {
  loop: true,
  // Navigation arrows
  navigation: {
...
var initSwiperTours = exports.initSwiperTours = new Swiper('.swiper-tours', {
  // Navigation arrows
  navigation: {
...
var initSwiperTrainers = exports.initSwiperTrainers = new Swiper('.training__trainers', {
  // Navigation arrows
  navigation: {
